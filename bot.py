...
CONSULTABOT_BUILD = "BUSCA_PROFUNDA_DEFINITIVA_CNJ_FILTER_2026_05_16"
...
def listar_requests_fallback(item, valor=None):
    ...
    try:
        for page in range(1, CODILO_FALLBACK_PAGES + 1):
            ...
            log_json("LIST REQUEST FALLBACK PROFUNDO PAGE", {"page": page, "params": params, "response": data}, 6000)
