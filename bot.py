...
CODILO_MAX_POLL_ATTEMPTS = int(os.getenv("CODILO_MAX_POLL_ATTEMPTS", "120"))
...
def buscar_cnjs(valor, tipo):
    ...
    for item in consultas:
        ...
        try:
            ...
            # NÃO usa mais /v1/request como fallback cego.
            # Esse endpoint lista requisições antigas da conta e pode misturar resultados
            # de outras buscas/OABs, geralmente puxando TRF4 e mascarando TJRS/TJSC.
