...
MAX_CODILO_REQUESTS = int(os.getenv("MAX_CODILO_REQUESTS", "250"))
...
UF_TRIBUNAIS = {
    # Importante: aqui ficam os tribunais que devem ter prioridade por UF.
    # RS e SC não podem ficar somente no TRF4, senão a busca fica parecendo
    # federal e os processos estaduais não aparecem.
    "RS": ["tjrs", "trf4", "trf4-jfrs", "jfrs", "trt4", "tst", "stj", "stf"],
    "SC": ["tjsc", "trf4", "trf4-jfsc", "jfsc", "trt12", "tst", "stj", "stf"],
    "PR": ["tjpr", "trf4", "trf4-jfpr", "jfpr", "trt9", "tst", "stj", "stf"],
    "GO": ["tjgo", "trf1", "trt18", "tst", "stj", "stf"],
    "TO": ["tjto", "trf1", "trt10", "tst", "stj", "stf"],
    "DF": ["tjdft", "trf1", "trt10", "tst", "stj", "stf"],
    "MG": ["tjmg", "trf6", "trf1", "trt3", "tst", "stj", "stf"],
    "SP": ["tjsp", "trf3", "trt2", "trt15", "tst", "stj", "stf"],
    "RJ": ["tjrj", "trf2", "trt1", "tst", "stj", "stf"],
    "BA": ["tjba", "trf1", "trt5", "tst", "stj", "stf"],
    "CE": ["tjce", "trf5", "trt7", "tst", "stj", "stf"],
}
